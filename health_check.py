...
#Checking health status of server
#This script should be executed regularly using Cron.
...
if __name__ == "__main__":
    ...
    if not check_cpu_usage(): # If there is not enough disk, 
